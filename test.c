...
//any expr that isnt explicitly 0 is mapped to 1
...
//and with c macros, thats all you need to put a semicolon at the end of each element of a list
//of variadic arguments. :) hope you enjoyed
